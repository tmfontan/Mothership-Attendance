 ...
 * @author tylerfontana
 */
public class StatusMessageManagementTabRemoveStudent extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public StatusMessageManagementTabRemoveStudent() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatusMessageManagementTabRemoveStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatusMessageManagementTabRemoveStudent().setVisible(true);
            }
        });
    }
