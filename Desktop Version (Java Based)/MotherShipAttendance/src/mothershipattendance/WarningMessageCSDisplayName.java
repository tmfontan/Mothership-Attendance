 ...
 * @author tylerfontana
 */
public class WarningMessageCSDisplayName extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageCSDisplayName() {
        initComponents();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        ConnectToServer.jLabel1.setText("Please Enter A Response in the Display Name Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageCSDisplayName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageCSDisplayName().setVisible(true);
            }
        });
    }
