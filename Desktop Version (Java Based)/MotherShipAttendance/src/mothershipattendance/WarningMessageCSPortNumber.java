 ...
 * @author tylerfontana
 */
public class WarningMessageCSPortNumber extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageCSPortNumber() {
        initComponents();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        ConnectToServer.jLabel1.setText("Please Enter A Response in the Port Number Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageCSPortNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageCSPortNumber().setVisible(true);
            }
        });
    }
