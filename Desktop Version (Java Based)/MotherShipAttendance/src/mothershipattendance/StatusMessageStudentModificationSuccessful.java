 ...
 * @author tylerfontana
 */
public class StatusMessageStudentModificationSuccessful extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public StatusMessageStudentModificationSuccessful(int value) {
        type = value;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Student Successfully Added.");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        // Renable Username Retrieval Components
        // in the Add Student Window
        if (type == 0) {
            AddStudentWindow.setSearchValueUsernameComponentsEnabled(true);
            // Renable the Students In Class Table Components
            // Seeing as the Operation Has Finished.
            ManageStudentsPanel.enableStudentsInClassTableComponents(true);
        }
        else if (type == 1) {
            AddStudentWindow.setSearchValueIDComponentsEnabled(true);
        }
        // If this Window Is Being Created From
        // the Remove Student Form in the Manage
        // Student Access Tab.
        else if (type == 2) {
            // Do Nothing
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatusMessageStudentModificationSuccessful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatusMessageStudentModificationSuccessful(0).setVisible(true);
            }
        });
    }
