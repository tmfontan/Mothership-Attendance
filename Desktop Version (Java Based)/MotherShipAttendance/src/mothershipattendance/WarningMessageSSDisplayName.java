 ...
 * @author tylerfontana
 */
public class WarningMessageSSDisplayName extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageSSDisplayName() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("'Display Name' Information Field");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        SpecifyServerDetails.jLabel1.setText("Please Enter A Response in the Display Name Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageSSDisplayName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageSSDisplayName().setVisible(true);
            }
        });
    }
