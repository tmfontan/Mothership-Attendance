 ...
 * @author tylerfontana
 */
public class AccountCreationSuccessful extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public AccountCreationSuccessful() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Account Creation Successful.");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        tracker.setContinueToMainStatus(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccountCreationSuccessful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AccountCreationSuccessful().setVisible(true);
            }
        });
    }
