 ...
 * @author tylerfontana
 */
public class WarningMessageAttendanceServerNAC extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageAttendanceServerNAC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("There Are No Classes Associated");

        jLabel8.setFont(new java.awt.Font("Lucida Grande", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Class To Access This Feature.");
        ...
        jLabel7.setText("With This Account. Please Add A");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageAttendanceServerNAC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageAttendanceServerNAC().setVisible(true);
            }
        });
    }
