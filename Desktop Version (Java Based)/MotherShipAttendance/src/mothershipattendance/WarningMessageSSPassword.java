 ...
 * @author tylerfontana
 */
public class WarningMessageSSPassword extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageSSPassword() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("'Password' Information Field");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        SpecifyServerDetails.jLabel1.setText("Please Enter A Response in the Password Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageSSPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageSSPassword().setVisible(true);
            }
        });
    }
