 ...
 * @author tylerfontana
 */
public class WarningMessageSSPortNumber extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageSSPortNumber() {
        initComponents();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        SpecifyServerDetails.jLabel1.setText("Please Enter A Response in the Port Number Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageSSPortNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageSSPortNumber().setVisible(true);
            }
        });
    }
