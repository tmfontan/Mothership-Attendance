 ...
 * @author tylerfontana
 */
public class WarningMessageSSHostIPAddress extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageSSHostIPAddress() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Before Attempting To Continue.");
        ...
        jLabel7.setText("\"Host IP Address' Information Field");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        SpecifyServerDetails.jLabel1.setText("Please Enter A Response in the IP Address Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageSSHostIPAddress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageSSHostIPAddress().setVisible(true);
            }
        });
    }
