 ...
 * @author tylerfontana
 */
public class WarningMessageCSHostIPAddress extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageCSHostIPAddress() {
        initComponents();
    }
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        ...
        ConnectToServer.jLabel1.setText("Please Enter A Response in the IP Address Field.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageCSHostIPAddress.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageCSHostIPAddress().setVisible(true);
            }
        });
    }
