 ...
 * @author tylerfontana
 */
public class AuthenticationSuccesful extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public AuthenticationSuccesful() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Account Authentication Successful.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuthenticationSuccesful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuthenticationSuccesful().setVisible(true);
            }
        });
    }
