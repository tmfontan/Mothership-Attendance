 ...
 * @author tylerfontana
 */
public class WarningMessageManageStudentAccessSelectValidOption extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageManageStudentAccessSelectValidOption() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("<html><center>Please Select a Valid Search Option Before Attempting to Continue.</center></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageManageStudentAccessSelectValidOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageManageStudentAccessSelectValidOption().setVisible(true);
            }
        });
    }
