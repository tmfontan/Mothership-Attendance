 ...
 * @author tylerfontana
 */
public class ServerConnectionSuccessful extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Successfully Connected To:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        MainScreenStudent.jLabel55.setText("Status: Connected");
        MainScreenStudent.jLabel55.setVisible(true);
        MainScreenStudent.jLabel50.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServerConnectionSuccessful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServerConnectionSuccessful().setVisible(true);
            }
        });
    }
