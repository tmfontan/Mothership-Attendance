 ...
 * @author tylerfontana
 */
public class StatusMessageLinkClassOperationSuccess extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public StatusMessageLinkClassOperationSuccess() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Class Link Successful");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatusMessageLinkClassOperationSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StatusMessageLinkClassOperationSuccess().setVisible(true);
            }
        });
    }
