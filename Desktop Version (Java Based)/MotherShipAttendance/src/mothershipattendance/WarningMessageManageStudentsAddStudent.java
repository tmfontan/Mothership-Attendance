 ...
 * @author tylerfontana
 */
public class WarningMessageManageStudentsAddStudent extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public WarningMessageManageStudentsAddStudent(int value) {
        type = value;
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningMessageManageStudentsAddStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WarningMessageManageStudentsAddStudent(0).setVisible(true);
            }
        });
    }
