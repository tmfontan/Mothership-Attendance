 ...
 * @author tylerfontana
 */
public class ExportFileLoader extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Exporting File");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mothershipattendance/Image/ExportingDocument.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExportFileLoader.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExportFileLoader().setVisible(true);
            }
        });
    }
    ...
    public RecordsSearchObject type;
    public ExportDataThread thread = new ExportDataThread();
     ...
     *
     */
    public class ExportDataThread extends SwingWorker<Void,Void> {
